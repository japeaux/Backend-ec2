<?php
	...
	if (isset($postdata)) {
		...
		$Url="https://ws.sandbox.pagseguro.uol.com.br/v2/transactions/cancels?email=".$emailPagseguro."&token="."5A5CCE8C99C84A5BA72450A5D0CDDE92"."&transactionCode={$code}";
	    ...
	    // $sql = "UPDATE diwoDB.pagamentos SET  status = '7' WHERE code = '$code'";
