<?php
	...
	$codigodevalidacaodebairro =  $request->codigodevalidacaodebairro;
	 $estadoendereco =  $request->estadoendereco;
	$diapedebairro = $request->diapedebairro;
	$cep =$request->cep;	
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "UPDATE diwoDB.user SET cep='$cep',diapedebairro = '$diapedebairro', estadoendereco = '$estadoendereco', codigodevalidacaodebairro = '$codigodevalidacaodebairro',endereco='$endereco', bairro='$bairro', cidade='$cidade', numeroendereco='$numeroendereco', complemento='$complemento' WHERE iduser='$iduser'";
