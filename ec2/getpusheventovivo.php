...
//        $sql2="SELECT * FROM diwoDB.evento WHERE nomeevento= '$nomeevento' AND pushdiainicio = '$pushdiainicio' AND (estado = '0' OR estado = '2')";
	$sql2="SELECT * FROM diwoDB.evento WHERE nomeevento= '$nomeevento' AND pushdiainicio = '$pushdiainicio'	" ;	  
