<?php
	...
	$sql = "INSERT INTO diwoDB.posts (postTitulo, postTexto, postEstado, postTipo, postImagem, datadecriacao, iduser, username, apelido, profilepic, deviceToken, lng, lat, datadeacao) VALUES ('$postTitulo', '$postTexto', '$postEstado', '$postTipo', '$postImagem', '$datadecriacao', '$iduser', '$username', '$apelido', '$profilepic', '$deviceToken','$lng', '$lat', '$datadeacao')";
