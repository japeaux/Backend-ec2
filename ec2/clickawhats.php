<?php
    ...
    $postdata = file_get_contents("php://input");
        ...
        $sql = "INSERT INTO diwoDB.clickspost (idnegocio, nomenegocio, datadecriacao, iduser, nomeuser,estado, categorianegocio) VALUES ('$idnegocio', '$nomenegocio', '$datadecriacao', '$iduser', '$nomeuser', '$estado', '$categorianegocio')";
