<?php
	...
	$privado =  $request->privado;
        ...
        $sql = "INSERT INTO diwoDB.evento (nomeevento, duracao, diainicio, semana, diafim, dialimiteconfirmacao, descricao, pmin, patual, pmax, preco, precopor, adm, estado, admusername, nomelocal, endereco, cidade, lat, lng, dificuldade, genero, admapelido, eventopic, idComercioParceiro, tipodeevento, comerciodevicetoken, descontopacote, pushdiainicio, privado) VALUES ('$nomeevento', '$duracao', '$diainicio', '$semana', '$diafim', '$dialimiteconfirmacao', '$descricao', '$pmin', '$patual', '$pmax', '$preco', '$precopor', '$adm', '$estado', '$admusername', '$nomelocal', '$endereco', '$cidade', '$lat', '$lng', '$dificuldade', '$genero','$admapelido','$eventopic', '$idComercioParceiro', '$tipodeevento','$comerciodevicetoken', '$descontopacote', '$pushdiainicio', '$privado' )";
