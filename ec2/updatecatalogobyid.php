<?php
	...
	if (isset($postdata)) {
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "UPDATE diwoDB.catalogo SET tipo='$tipo',espec='$espec',descricao='$descricao',valorespec='$valorespec',valoradicional='$valoradicional', datamodificacao ='$datadevalidade' WHERE idcatalogo='$idcatalogo'";
