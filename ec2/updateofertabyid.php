<?php
	...
	$profilepic = $request->profilepic;	
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "UPDATE diwoDB.ofertas SET nomeoferta='$nomeoferta',descricao='$descricao',regras='$regras',chamada='$chamada',valoroferta='$valoroferta',valorinicial='$valorinicial',itensnum='$itensnum',tipoespec='$tipoespec',datadevalidade='$datadevalidade' , datamodificacao ='$datadevalidade', profilepic = '$profilepic' WHERE idofertas='$idofertas'";
