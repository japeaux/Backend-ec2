<?php
	...
	$idade = $request->idade;
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "UPDATE diwoDB.user SET username='$username',apelido='$apelido', idade='$idade', telefone='$telefone', descricao='$descricao', cidade='$cidade',profilepic='$profilepic' WHERE iduser='$iduser'";
