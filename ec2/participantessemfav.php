<?php
	...
	if (isset($postdata)) {
        ...
        $sql2 = "SELECT * FROM diwoDB.pessoaevento WHERE idevento = '$idevento' AND estado != 5 and estado !=7 and estado !=6 and estado !=8 AND estado != 4";
        ...
        $nrow = mysqli_num_rows($result);
          if($nrow >= 1){
            ...
            //$data = array("success"=>true, "token"=>21231231236  , "msg"=>'Deu certo', "nrow"=>$nrow);
