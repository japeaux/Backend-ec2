<?php
	...
	$cep = $request->cep;
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "UPDATE diwoDB.user SET cep='$cep', codigodevalidacaodebairro = '$codigodevalidacaodebairro',endereco='$endereco', bairro='$bairro', cidade='$cidade', numeroendereco='$numeroendereco', complemento='$complemento', enderecovalidado = null WHERE iduser='$iduser'";
