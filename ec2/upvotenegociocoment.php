...
//        $devicetoken = $request->devicetoken;
    ...
    mysqli_set_charset($mysqli, 'utf8');
        ...
        $sql = "INSERT INTO diwoDB.negociocomentarios (idnegocio, negociocomentario, datadecriacao, iduser, nomeuser, profilepic,estado) VALUES ('$idnegocio', '$negociocomentario', '$datadecriacao', '$iduser', '$nomeuser', '$profilepic','$estado')";
