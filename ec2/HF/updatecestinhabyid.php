<?php
	...
	if (isset($postdata)) {
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "UPDATE diwoDB.ofertas SET nomeoferta='$nomeoferta',descricao='$descricao',valorinicial='$valorinicial',valoroferta='$valoroferta',regras='$regras',itensnum='$itensnum', datamodificacao ='$datamodificacao' WHERE idofertas='$idofertas'";
