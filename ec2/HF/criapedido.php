<?php
    ...
    $postdata = file_get_contents("php://input");
        if (isset($postdata)) {
            ...
            $receberviawpp = $request->receberviawpp;
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
                ...
                $sql = "INSERT INTO diwoDB.pedido (idofertas, nomeoferta, nomeuser, iduser, valoroferta, metodopagamento, endereco, numeroendereco, complemento,  bairro,  status,  datadecriacao, devicetokenuser,  devicetokennegocio, idnegocio, nomenegocio, valortotal, valorentrega, troco, observacao, espec, qntositems, contatouser,app, cpfnanota,receberviawpp) VALUES ('$idofertas', '$nomeoferta', '$nomeuser', '$iduser', '$valoroferta', '$metodopagamento','$endereco', '$numeroendereco', '$complemento', '$bairro', '$status', '$datadecriacao', '$devicetokenuser', '$devicetokennegocio', '$idnegocio', '$nomenegocio','$valortotal', '$valorentrega', '$troco', '$observacao', '$espec','$qntositems', '$contatouser','$app', '$cpfnanota', '$receberviawpp')";
	 		...
	 		$sql3="UPDATE diwoDB.userwhitela SET dataultimopedido = '$datadecriacao' WHERE iduser = '$iduser' "; 
