<?php
	...
	$estado = $request->estado;
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "UPDATE diwoDB.produto SET nomeproduto='$nomeproduto',descricao='$descricao',valor='$valor',valoraux='$valoraux',valorpor='$valorpor',categoria='$categoria', datamodificacao ='$datamodificacao', estado ='$estado' WHERE idproduto='$idproduto'";
