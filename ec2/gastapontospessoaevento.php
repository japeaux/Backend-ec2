<?php
	...
	if (isset($postdata)) {
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "INSERT INTO diwoDB.pessoaevento (idevento,iduser, username, nomeevento, estado, apelido, borda, pontos) VALUES ('$idevento', '$iduser', '$username', '$nomeevento', '$estado', '$apelido', '$borda', '$pontos')";
