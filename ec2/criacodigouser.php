<?php
	...
	if (isset($postdata)) {
        ...
        $codigodatacriacao = $request->codigodatacriacao;
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "UPDATE diwoDB.user SET codigo = '$codigo', numcodigo = 0, codigodatacriacao = '$codigodatacriacao'   WHERE iduser='$iduser'";;
