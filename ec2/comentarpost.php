<?php
	...
	if (isset($postdata)) {
        ...
        $postscomentario = $request->postscomentario;
	...
	$postscomentario = $mysqli->real_escape_string($postscomentario);        
        $sql = "INSERT INTO diwoDB.postscomentarios (idpost, postscomentario, datadecriacao, iduser, nomeuser, profilepic, estado, devicetoken) VALUES ('$idpost', '$postscomentario', '$datadecriacao', '$iduser', '$nomeuser',  '$profilepic',  '$estado', '$devicetoken')";
