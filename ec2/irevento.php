<?php
 ...
 $nomeevento = $mysqli->real_escape_string($nomeevento);    
            ...
            $sql = "INSERT INTO diwoDB.pessoaevento (idevento, idadm, admusername, diainicio, diafim, iduser, username, confirmacao, nomeevento, estado, profilepic, devicetoken, apelido, borda, eventopic, idComercioParceiro, privado, pontos) VALUES ('$idevento', '$idadm', '$admusername', '$diainicio', '$diafim', '$iduser', '$username', '$confirmacao', '$nomeevento', '$estado', '$profilepic', '$devicetoken', '$apelido', '$borda', '$eventopic', '$idComercioParceiro','$privado', '$pontos')";
