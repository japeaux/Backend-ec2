<?php
	...
	if (isset($postdata)) {
        ...
        $sql2="SELECT * FROM diwoDB.penalidades WHERE iduser = $iduser AND estado!= 1";
        ...
        if(mysqli_num_rows($result) >= 1){
            ...
            $json_str = json_encode(array($data));
			echo  "$json_str"; 
		}else{
            $data = array("success"=>false, "msg"=>'Não sofreu nenhuma penalidade');
