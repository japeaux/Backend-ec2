<?php
	...
	$diapedebairro = $request->diapedebairro;
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $sql = "UPDATE diwoDB.userbairro SET  codigodevalidacaodebairro = '$codigodevalidacaodebairro',diapedebairro = '$diapedebairro' ,endereco='$endereco', bairro='$bairro', cidade='$cidade', numeroendereco='$numeroendereco', complemento='$complemento', UF='$UF' WHERE iduserbairro='$iduserbairro'";
