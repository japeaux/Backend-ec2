...
//           $qmehcomercio = nl2br(htmlentities($qmehcomercio, ENT_QUOTES, 'UTF-8'));
        ...
        $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
                ...
                $sql = "INSERT INTO diwoDB.comercio (iduser, nomecomercio, infocomercio, duracao, fotocomercio, comerciotoken, pmin, pmax, pmedio, preco, precopor, lat, lng, endereco, telefone, horariofuncionamento, semanafuncionamento, qmehcomercio, incluso, oqtem, descontopacote) VALUES ('$iduser', '$apelido', '$infocomercio', '$duracao', '$profilepic', '$devicetoken', '$pmin', '$pmax', '$pmedio', '$preco', '$precopor', '$lat', '$lng', '$endereco', '$telefone', '$horariofuncionamento', '$semanafuncionamento', '$qmehcomercio','$incluso', '$oqtem','$descontopacote')";
