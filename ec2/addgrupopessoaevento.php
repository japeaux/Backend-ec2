<?php
	...
	if (isset($postdata)) {
		...
		if ($idevento == "" ||$iduser == "" ||$estado == "" ) {
            ...
            $sql = "INSERT INTO diwoDB.pessoaevento (idevento, iduser, username, nomeevento, estado, profilepic, devicetoken, apelido, borda, eventopic) VALUES ('$idevento', '$iduser', '$username', '$nomeevento', '$estado', '$profilepic', '$devicetoken', '$apelido', '$borda', '$eventopic')";
