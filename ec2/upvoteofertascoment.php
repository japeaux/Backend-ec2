...
//        $devicetoken = $request->devicetoken;
    ...
    mysqli_set_charset($mysqli, 'utf8');
        ...
        $sql = "INSERT INTO diwoDB.ofertascomentarios (idofertas, ofertascomentario, datadecriacao, iduser, nomeuser, profilepic,estado) VALUES ('$idofertas', '$ofertascomentario', '$datadecriacao', '$iduser', '$nomeuser', '$profilepic','$estado')";
