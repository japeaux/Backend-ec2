<?php
    ...
    $token = $request->token;
       ...
       $mysqli = new mysqli("diwodb.c9c8abhxvhos.us-east-2.rds.amazonaws.com","diwoadmin","diwoadmin","diwoDB");
            ...
            $headers = array (
                    'Authorization: key=AAAAGSY-hw0:APA91bEBOYMhRARL1dUmmsBzOpR0XWGgW7_PT1E--JOw5sUodwixhen4AvPaD585g946XbzwUGJ0N9T6hWtma9EHSSzkwJ5juHCpu_THAG4TNNpcxf_JCN_toazjX1Xa90ZHcXs2Feac' ,//This is Server Key, you can get it from Firebase console ->  App Setting ->  Cloud Messaging Tab - Legacy server key
